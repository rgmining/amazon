...
# pylint: skip-file
#
# Review Graph Mining Amazon Advisor Dataset documentation build configuration file.
#
...
project = u'Amazon Dataset Loader'
copyright = u'2017, Junpei Kawamoto'
...
# To add GitHub link.
rst_prolog = """
:github_url: https://github.com/rgmining/amazon
"""
...
html_context = {
    "base_url": "https://rgmining.github.io/amazon/",
    "twitter": "@junkawamoto",
...
htmlhelp_basename = 'AmazonDatasetdoc'
...
latex_documents = [
    (master_doc, 'AmazonDataset.tex', u'Amazon Dataset Documentation',
...
man_pages = [
    (master_doc, 'amazondataset', u'Amazon Dataset Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AmazonDataset', u'Amazon Dataset Documentation',
     author, 'AmazonDataset', 'One line description of project.',
     'Miscellaneous'),
]
